...
(function($){
    ...
    var calculatePasswordStrength = function(){
        ...
        passwordStrength += 2 * Math.floor(text.length / 9);
        if (commonList().indexOf(text.toLowerCase()) == -1) {
    ...
    var commonList = function() {
      // 2500 most used passwords - lower case, because that's how we check them (capitals in a common password don't make it appreciably more secure)
      list = ['password',
        '123456',
        '12345678',
        '1234',
