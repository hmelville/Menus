  ...
  private
    def setup
      ...
      if params[:id]
        ...
        @shopping_list = ShoppingList.all.first || ShoppingList.create()
      end
      ...
      if @shopping_list.present?
        ...
        @shopping_list = ShoppingList.new(start_date: @start_date, end_date: @end_date).save
      end

      redirect_to shopping_list_path(@shopping_list) if action_name == "index"
    end

    def shopping_list_params
      params.require(:shopping_list).permit(:start_date, :end_date, :custom_action)
    end
end
