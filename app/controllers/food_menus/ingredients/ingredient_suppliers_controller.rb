module FoodMenus
  module Ingredients
    class IngredientSuppliersController < BaseController
      ...
      load_and_authorize_resource :ingredient_supplier, through: :ingredient, class: 'FoodMenus::Ingredients::IngredientSupplier'
      ...
      private
        ...
        def ingredient_supplier_params
          params.require(:food_menus_ingredients_ingredient_supplier).permit(FoodMenus::Ingredients::IngredientSupplier.permitted_attributes)
        end
    end
  end
end